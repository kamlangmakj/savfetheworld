                                ...
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select type="text" class="form-control" placeholder="ประเภทของรางวัล" name="rewards_category_id">
                                            <option value="1" @if($reward->rewards_category_id == 1) selected @endif>บัตรของขวัญเทสโก้โลตัส</option>
                                            <option value="2" @if($reward->rewards_category_id == 2) selected @endif>บัตรเติมน้ำมัน</option>
                                            <option value="3" @if($reward->rewards_category_id == 3) selected @endif>ส่วนลดค่าที่พัก/ค่าอาหาร</option>
                                        </select>
                                    </div>
                                    <div class="row">
